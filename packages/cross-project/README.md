...
`<coordination-root>/.agent-harnesses/runtime/cross-project/0.2.3`
...
and [graph](https://github.com/fabianomag/agent-harnesses/blob/v0.2.3/graphs/cross-project.graph.json).
