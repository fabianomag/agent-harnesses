...
`<raiz-coordenadora>/.agent-harnesses/runtime/cross-project/0.2.3`:
...
e o [diagrama](https://github.com/fabianomag/agent-harnesses/blob/v0.2.3/graphs/cross-project.graph.json).
