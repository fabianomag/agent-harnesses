...
```text
<python> -B tools/package_manager.py install --package orchestration --version 0.2.2 --root "<install-root>" --dry-run
<python> -B tools/package_manager.py install --package orchestration --version 0.2.2 --root "<install-root>" --apply
<python> -B tools/package_manager.py verify --package orchestration --version 0.2.2 --root "<install-root>"
```

The installed copy is `<install-root>/orchestration-0.2.2/`. The common package
...
- Immutable documentation URL: https://github.com/fabianomag/agent-harnesses/blob/v0.2.2/packages/orchestration/README.md
- Immutable install prompt: `Install this harness for me: https://github.com/fabianomag/agent-harnesses/releases/download/v0.2.2/orchestration-0.2.2.zip`
- Immutable source URL: https://github.com/fabianomag/agent-harnesses/tree/v0.2.2/packages/orchestration
...
- Immutable spec: https://github.com/fabianomag/agent-harnesses/blob/v0.2.2/graphs/orchestration.graph.json
