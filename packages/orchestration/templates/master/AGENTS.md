...
- Preview initialization and repair before explicit apply.
- Keep front-specific execution in the registered front.
- Recover a durable journal before any new mutation.
