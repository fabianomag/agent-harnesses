...
`<raiz-do-projeto>/.agent-harnesses/runtime/project-harness/0.2.1`:
...
Package version e state schema são independentes. O runtime `0.2.1` cria state
...
e o [diagrama](https://github.com/fabianomag/agent-harnesses/blob/v0.2.1/graphs/project-harness.graph.json).
