...
`<project-root>/.agent-harnesses/runtime/project-harness/0.2.3`
...
Package version and state schema are independent. Runtime `0.2.3` creates
...
immutable [catalog](https://github.com/fabianomag/agent-harnesses/blob/v0.2.3/catalog/harnesses.json),
and [graph](https://github.com/fabianomag/agent-harnesses/blob/v0.2.3/graphs/project-harness.graph.json).
