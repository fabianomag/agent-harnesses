...
Choose exactly one `v0.2.1` package asset:

| Public name | Selector | Asset |
| --- | --- | --- |
| Project Harness | `project-harness` | `project-harness-0.2.1.zip` |
| Workspace Harness | `workspace-coordination` | `workspace-coordination-0.2.1.zip` |
| Multi-Project Harness | `cross-project` | `cross-project-0.2.1.zip` |
| Control Plane Harness | `orchestration` | `orchestration-0.2.1.zip` |
...
at `<target>/.agent-harnesses/runtime/<id>/0.2.1`; it does not initialize the
