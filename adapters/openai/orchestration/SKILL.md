...
`<target>/.agent-harnesses/runtime/orchestration/0.2.3/`. Treat that runtime's
...
```text
python3 -B <target>/.agent-harnesses/runtime/orchestration/0.2.3/hq.py --root <workspace> --json <command>
```
